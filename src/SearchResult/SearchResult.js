...
class SearchResult extends React.Component {
    ...
    render() {
        ...
        return (<div id='singleElement' className='gridContainer'><div><p id='resultText'>{this.state.result}</p></div><div><p>{this.state.quantity}</p></div> <div><p><a id='addTag' onClick={this.increaseQuantity}>+</a>   <a id='removeTag' onClick={this.decreaseQuantity}>–</a></p></div> </div>);
    }
}
